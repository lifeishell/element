	  ...
	  expand: {
	    ...
	    renderCell: function renderCell(h, _ref5, proxy) {
	      ...
	      return h(
	        ...
	        [h(
	          'i',
	          { 'class': 'el-icon fa-angle-double-right fa-2x' },
	          []
	        )]
	      );
	    },
	...
	exports.default = {
	  ...
	  methods: {
	    validate: function validate(trigger) {
	      ...
	      model[this.prop] = data ? data : this.fieldValue;
	    ...
	    onFieldChange: function onFieldChange(data) {
	      if (this.validateDisabled) {
	        this.validateDisabled = false;
	        return;
	      }

	      this.validate({ trigger: 'change', data: data });
	    }
	  },
	  mounted: function mounted() {
	    if (this.prop) {
